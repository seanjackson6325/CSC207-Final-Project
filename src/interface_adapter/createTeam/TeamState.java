...
public class TeamState
{
    ...
    private boolean isEditTodoFailed;
    ...
    public void setIsEditTodoFailed(boolean status)
    {
        this.isEditTodoFailed = status;
    }

    public boolean getIsEditTodoFailed()
    {
        return isEditTodoFailed;
    }
